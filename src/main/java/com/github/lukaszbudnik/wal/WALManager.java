...
/**
 * High-level manager for Write Ahead Log operations.
 * Provides convenience methods and manages sequence number generation.
...
public class WALManager implements AutoCloseable {
    ...
    /**
     * Create a new WAL entry with auto-generated sequence number and current timestamp.
     * This method is thread-safe - sequence number generation and appending are atomic.
     */
    ...
    /**
     * Create a new WAL entry with auto-generated sequence number (convenience method for byte array data).
     * This method is thread-safe - sequence number generation and appending are atomic.
     */
    ...
    /**
     * Create multiple WAL entries atomically with auto-generated consecutive sequence numbers.
     * This method is thread-safe - all entries are created and appended as a single atomic operation.
     */
    ...
    /**
     * Create multiple WAL entries atomically (convenience method for byte array data).
     * This method is thread-safe - all entries are created and appended as a single atomic operation.
     */
     ...
     */
    public List<WALEntry> readRange(long fromSequenceNumber, long toSequenceNumber) throws WALException {
     ...
     * Note: This is for informational purposes only. For thread-safe entry creation,
     * use createEntry() or createEntryBatch() methods instead.
     */
