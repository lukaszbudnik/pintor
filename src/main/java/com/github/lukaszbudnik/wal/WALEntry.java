 ...
 * Each entry contains a sequence number, timestamp, and data payload.
 * 
 * This is a simple POJO - serialization is handled by the WAL implementation.
 * Record types and transaction IDs should be embedded in the data payload by the application.
 */
public class WALEntry {
    ...
    public String toString() {
        return String.format("WALEntry{seq=%d, timestamp=%s, dataSize=%d}",
